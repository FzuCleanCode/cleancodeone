...
public class getNonlineFriend extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<User> friends=userService.getNonlineFriends(id);
		...
		request.getRequestDispatcher("/WEB-INF/page/Nonlinefriends.jsp").forward(request,response);
