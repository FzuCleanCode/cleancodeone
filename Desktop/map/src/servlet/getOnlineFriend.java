...
public class getOnlineFriend extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		List<User> friends=userService.getOnlineFriends(id);
		...
		request.getRequestDispatcher("/WEB-INF/page/Onlinefriends.jsp").forward(request,response);
