...
OnGetRoutePlanResultListener{
    ...
    public void SearchButtonProcess(View v) {
        ...
        PlanNode stNode = PlanNode.withCityNameAndPlaceName("福建省", editSt.getText().toString());
        PlanNode enNode = PlanNode.withCityNameAndPlaceName("福建省", editEn.getText().toString());
